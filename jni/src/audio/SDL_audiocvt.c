...
SDL_ConvertAudio(SDL_AudioCVT * cvt)
{
    ...
    if (cvt->buf == NULL) {
        SDL_SetError("No data allocated for conversion");
        return (-1);
    }
...
{
    /*
     * !!! FIXME: reorder filters based on which grow/shrink the data.
     * !!! FIXME: ideally, we should do everything that shrinks the data
