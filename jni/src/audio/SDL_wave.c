...
MS_ADPCM_decode(Uint8 ** audio_buf, Uint32 * audio_len)
{
    ...
    /* Allocate the proper sized output data */
...
/* Fill the decode data with a channel block of data (8 samples) */
static void
    ...
    *audio_buf = (Uint8 *) SDL_malloc(*audio_len);
    ...
    while (encoded_len >= IMA_ADPCM_state.wavefmt.blockalign) {
        ...
        for (c = 0; c < channels; ++c) {
            ...
            /* Reserved byte in data header, should be 0 */
            if (*encoded++ != 0) {
               ...
               SDL_AudioSpec * spec, Uint8 ** audio_buf, Uint32 * audio_len)
{
    ...
    spec->samples = 4096;       /* Good default data size */
    ...
    *audio_buf = NULL;
    ...
    /* Don't return a data that isn't a multiple of samplesize */
