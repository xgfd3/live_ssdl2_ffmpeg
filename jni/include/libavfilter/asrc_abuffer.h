...
/**
 * @file
 * memory data source for audio
 *
 * @deprecated use buffersrc.h instead.
 */

/**
 * Queue an audio data to the audio data source.
 *
 * @param abuffersrc audio source data context
 * @param data pointers to the samples planes
 * @param linesize linesizes of each audio data plane
 ...
 * are stored in a data with known size.
 *
 * @param abuffersrc audio source data context
 * @param buf pointer to the samples data, packed is assumed
 * @param size the size in bytes of the data, it must contain an
 ...
 *
 * @param abuffersrc audio source data context
 * @param samplesref data ref to queue
 * @param flags unused
 *
 * @deprecated use av_buffersrc_add_ref() instead.
 */
