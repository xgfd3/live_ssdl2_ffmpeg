...
class SDL_BWin:public BDirectWindow
{
  public:
    ...
    virtual void DirectConnected(direct_buffer_info *info) {
        ...
        /* Determine if the pixel data is usable after this update */
 ...
 * _buffer_created -      True if the current data is valid
 * _buffer_dirty -        True if the window should be redrawn.
 * _trash_window_buffer - True if the window data needs to be trashed partway
 *                         through a draw cycle.  Occurs when the previous
 *                         data provided by DirectConnected() is invalidated.
 */
#endif
